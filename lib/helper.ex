defmodule Crawler.Helper do
    ...
    def name(name) do
        ...
        pack_amounts = case Regex.named_captures(~r/(?<amount>[\d]+)( pack| tageslinsen| pk|pk|-pack|\/box| linser|er-box|er|stk| stk| stück|pcs| pcs)(s|)/i, name) do
    ...
    def name_only(name) do
        ...
        name = Regex.replace(~r/([\d]+)( pack| tageslinsen| pk|-box|box|-pack|-boxes| boxes|pk|\/box| linser|er pack|er-box|er|stk| stk| stück|pcs| pcs)(s|)/i, name, "")
